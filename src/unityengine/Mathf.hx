...
extern class Mathf {
	...
	public static function CorrelatedColorTemperatureToRGB(kelvin:Float) : unityengine.Color;
	...
	public static function FloatToHalf(val:Float) : UInt;
	...
	public static function HalfToFloat(val:UInt) : Float;
	...
	public static function Max(values:cs.NativeArray<cs.system.Single>) : Float;

	@:overload(function(a:Float, b:Float) : Float {})
	@:overload(function(a:Int, b:Int) : Int {})
	@:overload(function(values:cs.NativeArray<Int>) : Int {})
	public static function Min(values:cs.NativeArray<cs.system.Single>) : Float;
